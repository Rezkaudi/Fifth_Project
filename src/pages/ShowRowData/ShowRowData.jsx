...
const ShowRowData = () => {
    ...
    }, [rowId, formData, modelData, navigate])
                ...
                <div className="p-5">
                    <div className="contentContainer">
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                <h3 className='text-c2 text-2xl font-black mr-4'>Show row data </h3>
